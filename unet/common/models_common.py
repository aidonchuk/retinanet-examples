...
class ResNet34(nn.Module):
    ...
    def __init__(self, num_classes=1, num_filters=32, pretrained=True, is_deconv=True, requires_grad=True,
        ...
        self.center = DecoderBlock(512, num_filters * 8 * 2, num_filters * 8, is_deconv, one_conv=one_conv)
        ...
        self.dec2 = DecoderBlock(64 + num_filters * 2, num_filters * 2 * 2, num_filters * 2 * 2, is_deconv,
                                 one_conv=one_conv)
        self.dec1 = DecoderBlock(num_filters * 2 * 2, num_filters * 2 * 2, num_filters, is_deconv, one_conv=one_conv)
        self.dec0 = ConvRelu(num_filters, num_filters)
        self.final = nn.Conv2d(num_filters, num_classes, kernel_size=1)
